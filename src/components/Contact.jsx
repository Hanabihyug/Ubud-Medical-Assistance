        ...
        <Container>
          ...
          >
            <animated.h1
              ...
              style={fadeInTitle}
            >
              <div className=" max-sm:hidden h-16 w-2.5 bg-main-700"></div> Feel
              free to Contact Us
            </animated.h1>
            <animated.p
              ...
              style={fadeInText}
            >
              We believe that optimal health is important. Feel free to get to
              know us more, and we will provide the best advice for you.
            </animated.p>
            {/* Tautan WhatsApp */}
            <a
              href={whatsappLink}
